                                        ...
                                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td></td>
                                                   	<td>
													<c:if test="${f eq 10 }"><a href="complaintReply.jsp"><i class="mdi mdi-reply lead"></i></a></c:if>
													<c:if test="${f eq 20 }"><input type="submit" value="Replied" disabled="disabled"></c:if>
													</td>
                                                    <td><a href="#">
