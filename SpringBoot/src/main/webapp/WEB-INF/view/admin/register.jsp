                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="<%=request.getContextPath()%>/adminResources/image/logo-dark.png" alt="" height="22">
                                            </span>
                                        </a>
                    
                                        <a href="index.html" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                                <img src="<%=request.getContextPath()%>/adminResources/image/logo-light.png" alt="" height="22">
                                            </span>
                                        </a>
                                    </div>
