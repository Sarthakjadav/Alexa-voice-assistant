                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="/" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="<%=request.getContextPath()%>/adminResources/image/AVAHM2.png" alt="" height="70">
                                            </span>
                                        </a>
                    
                                        <a href="/" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                               <img src="<%=request.getContextPath()%>/adminResources/image/AVAHM.png" alt="" height="20">
                                            </span>
                                        </a>
                                    </div>
                                ...
                                <form action="/j_spring_security_check" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="email" name="username" id="emailaddress" required="required" placeholder="Enter your email">
                                    </div>
