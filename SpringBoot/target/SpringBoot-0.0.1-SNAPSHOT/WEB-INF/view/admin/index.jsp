...
<link href="<%=request.getContextPath()%>/adminResources/css/flatpickr.min.css" rel="stylesheet"
	type="text/css" />
<link href="<%=request.getContextPath()%>/adminResources/css/selectize.bootstrap3.css"
...
<body data-layout-mode="default" data-theme="light"
								...
								<div class="page-title-right">
									<form class="d-flex align-items-center mb-3">
										...
										<a href="javascript: void(0);"
											class="btn btn-blue btn-sm ms-2"> <i
											class="mdi mdi-autorenew"></i>
										</a> <a href="javascript: void(0);"
											class="btn btn-blue btn-sm ms-1"> <i
									...
									<div class="row">
										<div class="col-6">
											<div
												...
												<i
													class="fe-shopping-cart font-22 avatar-title text-success"></i>
											</div>
										</div>
										<div class="col-6">
											<div class="text-end">
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="widget-chart text-center" dir="ltr">
										...
										<p class="text-muted w-75 mx-auto sp-line-2">Traditional
											heading elements are designed to work best in the meat of
											your page content.</p>
										...
										<div class="row mt-3">
											...
											<div class="col-4">
												<p class="text-muted font-15 mb-1 text-truncate">Last
													week</p>
												<h4>
											...
											<tbody>
												<tr>
													<td style="width: 36px;"><img
														src="<%=request.getContextPath()%>/adminResources/image/user-2.jpg" alt="contact-img"
														title="contact-img" class="rounded-circle avatar-sm" /></td>
													...
													<td><i class="mdi mdi-currency-btc text-primary"></i>
														BTC</td>
													...
													<td><a href="javascript: void(0);"
														class="btn btn-xs btn-light"><i class="mdi mdi-plus"></i></a>
														<a href="javascript: void(0);"
														class="btn btn-xs btn-danger"><i class="mdi mdi-minus"></i></a>
													</td>
												</tr>

												<tr>
													<td style="width: 36px;"><img
														src="<%=request.getContextPath()%>/adminResources/image/user-3.jpg" alt="contact-img"
														title="contact-img" class="rounded-circle avatar-sm" /></td>
													...
													<td><i class="mdi mdi-currency-eth text-primary"></i>
														ETH</td>
												...
												<tr>
													<td style="width: 36px;"><img
														src="<%=request.getContextPath()%>/adminResources/image/user-4.jpg" alt="contact-img"
														title="contact-img" class="rounded-circle avatar-sm" /></td>
													...
													<td><i class="mdi mdi-currency-eur text-primary"></i>
														EUR</td>
												...
												<tr>
													<td style="width: 36px;"><img
														src="<%=request.getContextPath()%>/adminResources/image/user-5.jpg" alt="contact-img"
														title="contact-img" class="rounded-circle avatar-sm" /></td>
													...
													<td><i class="mdi mdi-currency-cny text-primary"></i>
														CNY</td>
												...
												<tr>
													<td style="width: 36px;"><img
														src="<%=request.getContextPath()%>/adminResources/image/user-6.jpg" alt="contact-img"
														title="contact-img" class="rounded-circle avatar-sm" /></td>
										...
										<table
											...
											<tbody>
												<tr>
													...
													<td><span class="badge bg-soft-warning text-warning">Upcoming</span>
													</td>
												...
												<tr>
													...
													<td><span class="badge bg-soft-success text-success">Paid</span>
													</td>
												...
												<tr>
													...
													<td><span class="badge bg-soft-danger text-danger">Overdue</span>
													</td>
 ...
 --%>			<!-- content -->
	...
	<script src="<%=request.getContextPath()%>/adminResources/js/selectize.min.js"></script>

	<!-- Dashboar 1 init js-->
	<script src="<%=request.getContextPath()%>/adminResources/js/dashboard-1.init.js"></script>
